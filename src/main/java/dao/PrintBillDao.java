...
public class PrintBillDao {
    ...
    public Voucher packageVoucher(ArrayList arrayList) {
        ...
        if (arrayList.size() != 0) {
            ...
            // 读取数据库记录中的字段
            int watercourse_num = (Integer) arrayList2.get("watercourseNum");
            int atm_id = (Integer) arrayList2.get("atmId");
            int money = (Integer) arrayList2.get("money");
            Timestamp updateTime = (Timestamp) arrayList2.get("updateTime");
            int cardNo = (Integer) arrayList2.get("cardNo");
            int optionNum = (Integer) arrayList2.get("optionNum");
